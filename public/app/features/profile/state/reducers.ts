...
import { dateTimeFormat, dateTimeFormatTimeAgo, setWeekStart, TimeZone, WeekStart } from '@grafana/data';
...
export const slice = createSlice({
  ...
  reducers: {
    ...
    updateWeekStart: (state, action: PayloadAction<{ weekStart: TimeZone }>) => {
